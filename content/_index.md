  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        <a href="https://github.com/deinprofil" target="_blank" class="p-3 rounded-full bg-white/50 hover:bg-white/80 dark:bg-slate-800/50 dark:hover:bg-slate-700 transition shadow-sm backdrop-blur-sm" aria-label="GitHub">
